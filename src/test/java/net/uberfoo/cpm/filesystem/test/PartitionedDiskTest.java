...
public class PartitionedDiskTest {
    ...
    public void testReadDisk() throws Exception {
        ...
        assertThat(partitionedDisk.getDiskSize(), is(0x0101_7000));
    }

    @Test
    public void testCreateDisk2() throws Exception {
        var disk1 = new LabeledDisk("BOOT", makeDisk(TestDiskParameterBlocks.Z80RB_BOOT_DPB));
        var disk2 = new LabeledDisk("Floppy Drive", makeDisk(TestDiskParameterBlocks.OSBORNE_1_DPB));
        var disk3 = new LabeledDisk("Drive C", makeDisk(TestDiskParameterBlocks.Z80RB_DPB));
        ...
        //Files.write(Path.of("src/test/resources/test_part_disk.img"), buffer.array(), StandardOpenOption.CREATE);
    }
}
